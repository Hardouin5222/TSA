...
class FlightController extends Controller
{
    ...
    protected $flightSearchManager;
    /**
     * @var string
     */
    private $locationCategoryClass;

    public function __construct(Flight $flightClass, Location $locationClass, FlightSearchManager $flightSearchManager)
    {
        $this->flightClass = $flightClass;
        $this->locationClass = $locationClass;
        $this->flightSearchManager = $flightSearchManager;
    }
    ...
    {
        if ($this->flightSearchManager->usesSupplierMode()) {
            $supplierData = $this->flightSearchManager->search($request->all());

            return view('Flight::frontend.search-supplier', array_merge($supplierData, [
                "seo_meta" => $this->flightClass::getSeoMetaForPageList(),
            ]));
        }

        // Buradan sonrası eski Booking Core search akışı olarak kalacak
